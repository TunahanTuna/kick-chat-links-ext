      ...
      {links.length === 0 ? (
        ...
        <div className="flex-1 overflow-y-auto space-y-1.5 sm:space-y-2 lg:space-y-3 pr-1 sm:pr-2">
          {links.map((link, index) => (
            <div
              key={link.url}
              className="group link-card animate-slide-in-bottom rounded-lg sm:rounded-xl bg-theme-tertiary hover:bg-[#2D3138] p-2.5 sm:p-3 lg:p-4 transition-smooth interactive-scale"
